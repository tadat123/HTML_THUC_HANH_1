<html>
  <head>
    ...
    />
    <title>Netflix Viet Nam - Watch TV Shows Online, Watch Movies Online</title>
    <link
      rel="icon"
      href="image/pngwing.com.png"
    />
  </head>
  <body>
    <header>
        ...
        <div class="navbar__nav__items">
          <div class="nav__item">
            <div class="dropdown__container">
              ...
              >
                <option value="english" selected style="color: rgb(247, 247, 247);">English</option>
                <option value="vietnam" style="color: rgb(255, 253, 253);">Tiếng Việt</option>
              </select>
            </div>
          </div>
    ...
    <main>
      <section class="hero">
        <div class="hero__bg__image__container">
          <img
            src="image/netflix-background-128505-385441-537479.png"
            alt="BG hero image"
    ...
    <footer>
      <div class="footer__row__1">
        <h4>Questions? Call 0398-736-388</h4>
      </div>
